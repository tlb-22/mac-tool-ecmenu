...
<p align="center">
  <img src=".docs/images/overview-zh-Hans.png" width="100%" alt="ECMenu 通用设置、右键菜单设置与 Finder 菜单">
</p>
...
在“文件模板”页面导入普通文件，修改菜单显示名和默认文件名，或删除模板。ECMenu 保存独立副本，并在首次使用时提供一个空白 TXT 模板。新建文件保留模板内容；名称冲突时依次使用 `_copy`、`_copy2` 等后缀。
