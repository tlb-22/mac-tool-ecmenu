...
final class NewFileTests: XCTestCase {
    func testInitialTXTTemplateCreatesAnEmptyFile() async throws {
        ...
        let templates = try await fixture.library.load()
...
nonisolated private struct NewFileFixture {
    ...
    init() throws {
        ...
        library = FileTemplateLibrary(rootURL: rootURL.appendingPathComponent("FileTemplates"))
        try FileManager.default.createDirectory(at: destinationURL, withIntermediateDirectories: false)
    }

    var libraryURL: URL { rootURL.appendingPathComponent("FileTemplates") }
    ...
    func importTemplate(named name: String, data: Data) async throws -> FileTemplate {
        ...
        let templates = try await library.importFile(at: sourceURL)
