/**
 验证设置页读取外部应用依赖和 Finder Extension 状态的刷新边界。
 通过注入系统事实检查可用性派生，并确认不可用状态保留用户菜单偏好。
 */
...
final class StatusPageSystemStateTests: XCTestCase {
    ...
    func testConfigurationAvailabilityPreservesSavedVisibility() {
        ...
        XCTAssertTrue(CommandMenuConfigPage.isVisibilityEditable(
            for: command, configuration: configuration, systemState: installed
        ))
        XCTAssertFalse(CommandMenuConfigPage.isVisibilityEditable(
