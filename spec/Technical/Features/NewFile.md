...
sequenceDiagram
    ...
    box ECMenu 主应用进程
        participant H as CreateNewFileHandler
        participant T as FileTemplateOperations / Library
        participant W as NewFileWriter
        participant F as CreateNewFileFeedback
    end
